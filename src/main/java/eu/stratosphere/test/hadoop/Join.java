package eu.stratosphere.test.hadoop;
...
public class Join extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    StratosphereHadoopJobClient client = new StratosphereHadoopJobClient(jobConf);
    int num_maps = 10;
    int num_reduces = 10;
    ...
    RunningJob running = client.submitJob(jobConf);
